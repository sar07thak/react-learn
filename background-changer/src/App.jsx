    ...
    <>
      <div className="h-screen flex  flex-col justify-center items-center text-white duration-300 shadow-xl shadow-indigo-500/40 " style={{backgroundColor:color}}>
        ...
        <div className="bg-white flex w-[80%]  justify-evenly p-4 rounded-md flex-wrap gap-0.5">
          <button className="relative z-0 rounded bg-red-500 px-10 py-3 transition-[all_0.3s_ease] after:absolute after:left-0 after:top-0 after:-z-10 after:h-full after:w-0 after:rounded after:bg-red-700 after:transition-[all_0.3s_ease]  hover:after:w-full"
           onClick={() => {
            setColor("#EF4444");
          }}>Red</button>
