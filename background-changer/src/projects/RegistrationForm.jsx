...
export const Registeraion = () => {
  ...
  return (
    <>
      <form
        className="bg-gray-200  flex justify-center p-2 h-screen "
      ...
      >
        <div className="flex  flex-col  items-center">
          ...
          <div className=" flex flex-col  p-10  rounded-xl  shadow-2xl shadow-gray-600 bg-white  max-w-[60%] min-w-[90%]">
            ...
            <input
              ...
              id=""
              value={phone}
              className="mb-5 p-1.5 bg-gray-100 text-gray-600"
              onChange={handlephone}
            />

            <p className="text-md text-gray-500 mb-5">
              By Creating an account you agree to our ?{" "}
              <span className="text-blue-500 font-bold">Term and Policy</span>
            </p>
